...
from g2lformer.loader.dataset.aqsol_molecules import AQSOL
from g2lformer.loader.dataset.coco_superpixels import COCOSuperpixels
from g2lformer.loader.dataset.malnet_tiny import MalNetTiny
from g2lformer.loader.dataset.voc_superpixels import VOCSuperpixels
from g2lformer.loader.split_generator import (prepare_splits,
                                             set_dataset_splits)
from g2lformer.transform.posenc_stats import compute_posenc_stats
from g2lformer.transform.task_preprocessing import task_specific_preprocessing
from g2lformer.transform.transforms import (pre_transform_in_memory,
...
def preformat_OGB_Graph(dataset_dir, name):
    ...
    if name == 'ogbg-ppa':
        ...
        from g2lformer.loader.ogbg_code2_utils import idx2vocab, \
...
def preformat_PCQM4Mv2Contact(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary
        from g2lformer.loader.dataset.pcqm4mv2_contact import \
...
def preformat_Peptides(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary.
        from g2lformer.loader.dataset.peptides_functional import \
            PeptidesFunctionalDataset
        from g2lformer.loader.dataset.peptides_structural import \
